...
page_title: "schemas_panel_text Data Source - terraform-provider-schemas"
subcategory: ""
description: |-
  
---

# schemas_panel_text (Data Source)
...
- `type` (String) The panel plugin type id. This is used to find the plugin to display the panel. Defaults to "text".
