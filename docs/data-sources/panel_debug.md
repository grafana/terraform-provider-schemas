...
page_title: "schemas_panel_debug Data Source - terraform-provider-schemas"
subcategory: ""
description: |-
  
---

# schemas_panel_debug (Data Source)
...
- `type` (String) The panel plugin type id. This is used to find the plugin to display the panel. Defaults to "debug".
