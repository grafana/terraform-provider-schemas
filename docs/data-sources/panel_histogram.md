...
page_title: "schemas_panel_histogram Data Source - terraform-provider-schemas"
subcategory: ""
description: |-
  
---

# schemas_panel_histogram (Data Source)
...
- `type` (String) The panel plugin type id. This is used to find the plugin to display the panel. Defaults to "histogram".
...
- `bucket_offset` (Number) Offset buckets by this amount. Defaults to 0.
