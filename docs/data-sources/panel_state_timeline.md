...
page_title: "schemas_panel_state_timeline Data Source - terraform-provider-schemas"
subcategory: ""
description: |-
  
---

# schemas_panel_state_timeline (Data Source)
...
- `type` (String) The panel plugin type id. This is used to find the plugin to display the panel. Defaults to "state-timeline".
...
- `align_value` (String) Controls value alignment on the timelines. Defaults to "left".
- `legend` (Attributes) (see [below for nested schema](#nestedatt--options--legend))
- `merge_values` (Boolean) Merge equal consecutive values. Defaults to true.
- `row_height` (Number) Controls the row height. Defaults to 0.900000.
- `show_value` (String) Show timeline values on chart. Defaults to "auto".
