...
page_title: "schemas_panel_canvas Data Source - terraform-provider-schemas"
subcategory: ""
description: |-
  
---

# schemas_panel_canvas (Data Source)
...
- `type` (String) The panel plugin type id. This is used to find the plugin to display the panel. Defaults to "canvas".
...
- `inline_editing` (Boolean) Enable inline editing. Defaults to true.
- `root` (Attributes) The root element of canvas (frame), where all canvas elements are nested
TODO: Figure out how to define a default value for this (see [below for nested schema](#nestedatt--options--root))
- `show_advanced_types` (Boolean) Show all available element types. Defaults to true.

<a id="nestedatt--options--root"></a>
### Nested Schema for `options.root`

Required:

- `name` (String) Name of the root element
- `type` (String) Type of root element (frame)

Optional:

- `elements` (Attributes List) The list of canvas elements attached to the root element (see [below for nested schema](#nestedatt--options--root--elements))

<a id="nestedatt--options--root--elements"></a>
### Nested Schema for `options.root.elements`
...
- `background` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--background))
- `border` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--border))
- `connections` (Attributes List) (see [below for nested schema](#nestedatt--options--root--elements--connections))
- `constraint` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--constraint))
- `placement` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--placement))

<a id="nestedatt--options--root--elements--background"></a>
### Nested Schema for `options.root.elements.placement`

Optional:

- `color` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--placement--color))
- `image` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--placement--image))
- `size` (String)

<a id="nestedatt--options--root--elements--placement--color"></a>
### Nested Schema for `options.root.elements.placement.color`
...
<a id="nestedatt--options--root--elements--placement--image"></a>
### Nested Schema for `options.root.elements.placement.image`
...
<a id="nestedatt--options--root--elements--border"></a>
### Nested Schema for `options.root.elements.placement`
...
<a id="nestedatt--options--root--elements--connections"></a>
### Nested Schema for `options.root.elements.placement`
...
- `color` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--placement--color))
- `size` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--placement--size))
- `source` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--placement--source))
- `target` (Attributes) (see [below for nested schema](#nestedatt--options--root--elements--placement--target))
- `target_name` (String)
...
<a id="nestedatt--options--root--elements--placement--size"></a>
### Nested Schema for `options.root.elements.placement.size`
...
<a id="nestedatt--options--root--elements--placement--source"></a>
### Nested Schema for `options.root.elements.placement.source`
...
<a id="nestedatt--options--root--elements--placement--target"></a>
### Nested Schema for `options.root.elements.placement.target`
...
<a id="nestedatt--options--root--elements--constraint"></a>
### Nested Schema for `options.root.elements.placement`
...
<a id="nestedatt--options--root--elements--placement"></a>
### Nested Schema for `options.root.elements.placement`
