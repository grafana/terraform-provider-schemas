...
- `type` (String) The panel plugin type id. This is used to find the plugin to display the panel. Defaults to "gauge".
...
- `show_threshold_labels` (Boolean) Defaults to false.
- `show_threshold_markers` (Boolean) Defaults to true.
