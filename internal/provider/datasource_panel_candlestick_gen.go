...
func (m PanelCandlestickDataSourceModel_Options_Fields_CandlestickFieldMap) MarshalJSON() ([]byte, error) {
	...
	m = m.ApplyDefaults()
	attr_open := m.Open.ValueStringPointer()
	attr_high := m.High.ValueStringPointer()
	attr_low := m.Low.ValueStringPointer()
	attr_close := m.Close.ValueStringPointer()
	attr_volume := m.Volume.ValueStringPointer()
...
func (m PanelCandlestickDataSourceModel_Options) MarshalJSON() ([]byte, error) {
	...
	attr_includeallfields := m.IncludeAllFields.ValueBoolPointer()
