...
var (
	_ datasource.DataSource              = &TempoDataQueryDataSource{}
	_ datasource.DataSourceWithConfigure = &TempoDataQueryDataSource{}
)

func NewTempoDataQueryDataSource() datasource.DataSource {
	return &TempoDataQueryDataSource{}
}

// TempoDataQueryDataSource defines the data source implementation.
type TempoDataQueryDataSource struct{}

// TempoDataQueryDataSourceModel describes the data source data model.
type TempoDataQueryDataSourceModel struct {
...
func (d *TempoDataQueryDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_tempodataquery"
}

func (d *TempoDataQueryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *TempoDataQueryDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
}

func (d *TempoDataQueryDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data TempoDataQueryDataSourceModel
