...
func (m PanelStateTimelineDataSourceModel_Options) MarshalJSON() ([]byte, error) {
	...
	var attr_mergevalues *bool
	if !m.MergeValues.IsNull() && !m.MergeValues.IsUnknown() {
		tmp := m.MergeValues.ValueBool()
		attr_mergevalues = &tmp
	}
	...
	var attr_alignvalue *string
	if !m.AlignValue.IsNull() && !m.AlignValue.IsUnknown() {
		tmp := m.AlignValue.ValueString()
		attr_alignvalue = &tmp
	}
