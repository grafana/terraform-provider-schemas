...
var (
	_ datasource.DataSource              = &StatPanelCfgDataSource{}
	_ datasource.DataSourceWithConfigure = &StatPanelCfgDataSource{}
)

func NewStatPanelCfgDataSource() datasource.DataSource {
	return &StatPanelCfgDataSource{}
}

// StatPanelCfgDataSource defines the data source implementation.
type StatPanelCfgDataSource struct{}

// StatPanelCfgDataSourceModel describes the data source data model.
type StatPanelCfgDataSourceModel struct {
	PanelOptions *struct {
		GraphMode     types.String `tfsdk:"graph_mode" json:"graphMode"`
		ColorMode     types.String `tfsdk:"color_mode" json:"colorMode"`
		JustifyMode   types.String `tfsdk:"justify_mode" json:"justifyMode"`
...
func (d *StatPanelCfgDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statpanelcfg"
}

func (d *StatPanelCfgDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *StatPanelCfgDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
}

func (d *StatPanelCfgDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data StatPanelCfgDataSourceModel
