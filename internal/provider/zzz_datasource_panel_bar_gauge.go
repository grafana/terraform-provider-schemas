...
// PanelBarGaugeDataSourceModelJSON describes the data source data model when exported to json.
type PanelBarGaugeDataSourceModelJSON struct {
	PanelOptions struct {
...
func (d PanelBarGaugeDataSourceModel) MarshalJSON() ([]byte, error) {
	...
	model := &PanelBarGaugeDataSourceModelJSON{
		Type:            attr_type,
		Id:              &attr_id,
