...
type PanelBarGaugeDataSourceModel_Targets struct {
}

func (m PanelBarGaugeDataSourceModel_Targets) MarshalJSON() ([]byte, error) {
	type jsonPanelBarGaugeDataSourceModel_Targets struct {
	}

	m = m.ApplyDefaults()

	model := &jsonPanelBarGaugeDataSourceModel_Targets{}
	return json.Marshal(model)
}

func (m PanelBarGaugeDataSourceModel_Targets) ApplyDefaults() PanelBarGaugeDataSourceModel_Targets {
...
func (m PanelBarGaugeDataSourceModel_FieldConfig_Defaults_Custom) MarshalJSON() ([]byte, error) {
	...
	if m.ThresholdsStyle != nil {
		attr_thresholdsstyle = m.ThresholdsStyle.ApplyDefaults()
	}
...
type PanelBarGaugeDataSourceModel struct {
	...
	Tags            types.List                                     `tfsdk:"tags"`
	Targets         []PanelBarGaugeDataSourceModel_Targets         `tfsdk:"targets"`
	Title           types.String                                   `tfsdk:"title"`
	Description     types.String                                   `tfsdk:"description"`
