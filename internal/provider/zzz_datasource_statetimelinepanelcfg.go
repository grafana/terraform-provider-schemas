...
var (
	_ datasource.DataSource              = &StateTimelinePanelCfgDataSource{}
	_ datasource.DataSourceWithConfigure = &StateTimelinePanelCfgDataSource{}
)

func NewStateTimelinePanelCfgDataSource() datasource.DataSource {
	return &StateTimelinePanelCfgDataSource{}
}

// StateTimelinePanelCfgDataSource defines the data source implementation.
type StateTimelinePanelCfgDataSource struct{}

// StateTimelinePanelCfgDataSourceModel describes the data source data model.
type StateTimelinePanelCfgDataSourceModel struct {
	PanelOptions *struct {
		ShowValue   types.String  `tfsdk:"show_value" json:"showValue"`
		RowHeight   types.Float64 `tfsdk:"row_height" json:"rowHeight"`
		MergeValues types.Bool    `tfsdk:"merge_values" json:"mergeValues"`
		Legend      *struct {
		...
		AlignValue types.String `tfsdk:"align_value" json:"alignValue"`
...
func (d *StateTimelinePanelCfgDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_statetimelinepanelcfg"
}

func (d *StateTimelinePanelCfgDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *StateTimelinePanelCfgDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
}

func (d *StateTimelinePanelCfgDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data StateTimelinePanelCfgDataSourceModel
