...
// PanelStatDataSourceModel describes the data source data model.
...
// PanelStatDataSourceModelJSON describes the data source data model when exported to json.
type PanelStatDataSourceModelJSON struct {
	PanelOptions struct {
...
func (d *PanelStatDataSource) applyDefaults(data *PanelStatDataSourceModel) {
	if data.PanelOptions.GraphMode.IsNull() {
		data.PanelOptions.GraphMode = types.StringValue(`area`)
	}
	if data.PanelOptions.ColorMode.IsNull() {
		data.PanelOptions.ColorMode = types.StringValue(`value`)
	}
	if data.PanelOptions.JustifyMode.IsNull() {
		data.PanelOptions.JustifyMode = types.StringValue(`auto`)
	}
	if data.PanelOptions.TextMode.IsNull() {
		data.PanelOptions.TextMode = types.StringValue(`auto`)
	}
...
func (d PanelStatDataSourceModel) MarshalJSON() ([]byte, error) {
	...
	model := &PanelStatDataSourceModelJSON{
		Type:            attr_type,
		Id:              &attr_id,
