...
// PanelNewsDataSourceModel describes the data source data model.
...
// PanelNewsDataSourceModelJSON describes the data source data model when exported to json.
type PanelNewsDataSourceModelJSON struct {
	PanelOptions struct {
...
func (d *PanelNewsDataSource) applyDefaults(data *PanelNewsDataSourceModel) {
	if data.PanelOptions.ShowImage.IsNull() {
		data.PanelOptions.ShowImage = types.BoolValue(true)
	}
...
func (d PanelNewsDataSourceModel) MarshalJSON() ([]byte, error) {
	...
	model := &PanelNewsDataSourceModelJSON{
		Type:            attr_type,
		Id:              &attr_id,
