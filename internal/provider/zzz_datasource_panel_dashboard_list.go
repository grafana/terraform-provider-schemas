...
// PanelDashboardListDataSourceModelJSON describes the data source data model when exported to json.
type PanelDashboardListDataSourceModelJSON struct {
...
func (d PanelDashboardListDataSourceModel) MarshalJSON() ([]byte, error) {
	attr_panellayout := d.PanelLayout.ValueString()
	...
	model := &PanelDashboardListDataSourceModelJSON{
